...
@REM set XERCESC_REPO=https://downloads.apache.org/xerces/c/3/sources/xerces-c-%XERCESC_VERSION%.zip
set XERCESC_REPO=https://dlcdn.apache.org//xerces/c/3/sources/%XERCESC_BASENAME%-%XERCESC_VERSION%.zip
